<?php require("include/baglan.php"); include("include/fonksiyon.php"); include_once("inc.lang.php"); 
	...
	$row_info = $db->query("SELECT * FROM kategoriler WHERE kategori_ust_id = {$catname3} AND dil_id = '{$varsayilanDil}'")->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="tr">
<head>
     <title><?php echo $row_info["kategori_baslik"]; ?> - Yontar Polyester </title>
	 <?php include("css.php")?>
</head> 
<body> 
    <div class="preloader">
        ...
        <section class="page-header clearfix" style="background-image: url(<?php echo $ayarlar["strURL"]; ?>/assets/images/backgrounds/page-header-bg.jpg);">
            <div class="container">
                <div class="page-header__inner clearfix">
                    <h2 class="wow slideInDown animated" data-wow-delay="0.3s" data-wow-duration="1500ms"><?php echo $row_info["kategori_baslik"]; ?>
                    </h2>
                    <ul class="thm-breadcrumb list-unstyled wow slideInUp animated" data-wow-delay="0.3s" data-wow-duration="1500ms">
                        ...
                        <li><?php echo $row_info["kategori_baslik"]; ?></li>
                    </ul>
                </div>
            </div>
        </section> 
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="team-one__content-wrapper">
                            ...
                            <div class="row">
                               <?php
				$veri_cek = $db->query("SELECT * FROM projeler WHERE proje_durum = 1 AND kategori_id = {$catname3} AND dil_id = '{$lang}' ORDER BY proje_ust_id DESC LIMIT 99");
