<?php require("../include/baglan.php");include("../include/fonksiyon.php"); 
		...
		define('TABLE',"referans2");
		define('AREA',"referanslar2");
		if(!isset($do)) $do = null; 
		$sayfa = (isset($q) ? $q : 1);
...
?>
										<tr id="item-<?php echo $row["haber_ust_id"]; ?>" role="row" class="even"> 
											...
											<td class=""><?php if(isset($row["haber_resim"])){ ?><img class="mr-3 " width="60" src="../uploads/referanslar2/<?php echo $row["haber_resim"]; ?>" alt="<?php echo $row["haber_baslik"]; ?>"><?php }else{ ?><img class="mr-3 " width="60" src="images/no_images.png" alt="<?php echo $row["haber_baslik"]; ?>"><?php } ?></td>
				...
				if(isset($submitControl)){
					if(!empty($_POST['haber_baslik']) || !empty($_POST['haber_aciklama'])) {
						...
						if ($upload->uploaded) { 
								...
								$upload->process("../uploads/referanslar2");
							if ($upload->processed){  
                            ...
                            <div class="card-body p-3">  
								...
								<?php }else{?> 
										<div class="fileinput fileinput-exists" data-provides="fileinput">
											...
											<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 303px; max-height: 190px; line-height: 190px;"><img src="../uploads/referanslar2/<?php echo $row_info["haber_resim"]; ?>" class="img-fluid img-thumbnail"></div>
											<div>
												<span class="btn btn-primary btn-sm btn-file">
													<span class="fileinput-new"><span class="fui-image"></span>Resim Seç</span>
													<span class="fileinput-exists"><span class="fui-gear"></span>Değiştir</span>
