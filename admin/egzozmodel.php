										...
										<tr id="item-<?php echo $row["model_ust_id"]; ?>" role="row" class="even"> 
											...
											<td class="sorting_1">
												<div class="d-flex">
													...
													<a class="contact-icon mr-3" href="<?php echo AREA; ?>?do=edit&id=<?php echo $row["model_ust_id"]; ?>&egzoz&egzoz_id=<?php echo $egzoz_id ?>"><i class="fas fa-edit" aria-hidden="true"></i></a>
													<a class="contact-icon" href="<?php echo AREA; ?>?do=delete&id=<?php echo $row["model_ust_id"]; ?>&egzoz&egzoz_id=<?php echo $egzoz_id ?>"><i class="fas fa-trash-alt"></i></a>
												</div>
											</td>
										</tr> 
<?php 	
