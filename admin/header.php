         ...
         <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="  ai-icon" href="kurumsal" aria-expanded="false">
							<i class="fas fa-cubes"></i>
							<span class="nav-text">Kurumsal</span>
						</a> 
                    </li> 
                    <li><a class="  ai-icon" href="hizmetlerimiz" aria-expanded="false">
							<i class="fas fa-users"></i>
							<span class="nav-text">Hizmetlerimiz</span>
						</a> 
                    </li> 
                     
					<li><a class="  ai-icon" href="satislar" aria-expanded="false">
							<i class="fas fa-shopping-cart"></i>
							<span class="nav-text">İşletmelerimiz</span>
						</a> 
                    </li> 
					<li><a class="  ai-icon" href="receteler" aria-expanded="false">
							<i class="far fa-file-alt"></i>
							<span class="nav-text">Bilgi Toplumu</span>
						</a> 
                    </li>  
					...
					<li class=""><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" class="mm-collapse" style="height: 16px;">
                            <li><a href="uc-select2.html">Dil Ekle</a></li>
                            <li><a href="uc-nestable.html">Dil Listesi</a></li>
                         </ul>
                    </li>
